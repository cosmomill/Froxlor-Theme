...
This is a fork of Froxlor-Theme that adds the ability to use it without changing Froxlor application core files. To use it, just copy the folder to your themes directory.
